...
struct HealthState {
  ...
  std::atomic<bool> python{false};
  std::atomic<std::int64_t> main_loop_ms{0};
  std::atomic<std::int64_t> reader_ms{0};
  std::atomic<std::int64_t> heartbeat_ms{0};
  std::atomic<std::int64_t> pool_ms{0};
};
