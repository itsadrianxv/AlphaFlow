...
TEST(PythonResponseTest, 接受连续排名的合法响应) {
  const auto result = PythonClient::parse_response(
      R"({"executionId":"run-1","status":"SUCCEEDED","asOfDate":"2026-07-29","universeCount":2,"evaluatedCount":2,"selectedCount":1,"rules":[],"results":[{"stockCode":"000001","stockName":"平安银行","rank":1,"selected":true,"evaluationStatus":"FULL","score":10,"minimumPossibleScore":-5,"maximumPossibleScore":10,"ruleResults":{}},{"stockCode":"600519","stockName":"贵州茅台","rank":2,"selected":false,"evaluationStatus":"FULL","score":0,"minimumPossibleScore":-5,"maximumPossibleScore":10,"ruleResults":{}}],"warnings":[],"diagnostics":{}})",
      "run-1");
...
TEST(PythonResponseTest, 拒绝重复股票和断裂排名) {
  EXPECT_THROW(PythonClient::parse_response(
                   R"({"executionId":"run-1","status":"SUCCEEDED","asOfDate":"2026-07-29","universeCount":2,"evaluatedCount":2,"selectedCount":0,"rules":[],"results":[{"stockCode":"000001","stockName":"平安银行","rank":1,"selected":false,"evaluationStatus":"FULL","score":0,"minimumPossibleScore":0,"maximumPossibleScore":10,"ruleResults":{}},{"stockCode":"000001","stockName":"平安银行","rank":3,"selected":false,"evaluationStatus":"FULL","score":0,"minimumPossibleScore":0,"maximumPossibleScore":10,"ruleResults":{}}],"warnings":[],"diagnostics":{}})",
                   "run-1"),
               WorkerError);
}
