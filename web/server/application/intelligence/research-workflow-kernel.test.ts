...
describe("research-workflow-kernel", () => {
  it("keeps industry default task contract on standard depth even with researchGoal", () => {
    expect(
      buildDefaultTaskContract({
        subject: "industry",
        preferences: {
  ...
  it("allows industry workflow to force structured planning onto reasoner", async () => {
