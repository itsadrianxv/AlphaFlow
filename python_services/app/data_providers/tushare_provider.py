...
RAW_DATASET_FIELDS: dict[str, str] = {
    ...
    "stk_factor_pro": "ts_code,trade_date,open,open_qfq,high,high_qfq,low,low_qfq,close,close_qfq,vol,amount,turnover_rate,volume_ratio,adj_factor,dmi_adx_qfq,dmi_mdi_qfq,dmi_pdi_qfq,ema_qfq_5,ema_qfq_20,ema_qfq_60,macd_qfq,macd_dea_qfq,macd_dif_qfq,rsi_qfq_12",
    "cyq_perf": "ts_code,trade_date,his_low,his_high,cost_5pct,cost_15pct,cost_50pct,cost_85pct,cost_95pct,weight_avg,winner_rate",
    "broker_recommend": "month,broker,ts_code,name",
    "report_rc": "ts_code,name,report_date,report_title,org_name,quarter,np,eps,rating,max_price,min_price",
    "stk_nineturn": "ts_code,trade_date,freq,open,high,low,close,vol,amount,up_count,down_count,nine_up_turn,nine_down_turn",
